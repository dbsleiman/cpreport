...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    echo -e "\e[32mUpdating Package Listing...\e[39m"
    apt-get update
    apt-get -y upgrade
    echo -e "\e[32mInstalling Packages...\e[39m"
    apt-get -y install python3
    apt-get -y install python3-pip
    echo -e "\e[32mInstalling PIP Requirements...\e[39m"
    cd /vagrant
    pip3 install -r requirements.txt
    echo -e "\e[32mSetting up aliases...\e[39m"
    echo 'alias python=python3' >> /home/vagrant/.bashrc
    echo 'alias pip=pip3' >> /home/vagrant/.bashrc
    echo -e "\e[32mVM Ready! Use vagrant ssh to start!\e[39m"
  SHELL
end
